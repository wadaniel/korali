...
/** \file
* @brief Header file for module: Cauchy.
*/

/** \dir distribution/univariate/cauchy
* @brief Contains code, documentation, and scripts for module: Cauchy.
*/
...
class Cauchy : public Univariate
{
  ...
  public: 
  /**
  * @brief [Conditional Variable Value] Specifies the location of the peak of the distribution.
  */
   double _location;
  /**
  * @brief [Conditional Variable Reference] Specifies the location of the peak of the distribution.
  */
   std::string _locationConditional;
  /**
  * @brief [Conditional Variable Value] Specifies the half-width at half-maximum (HWHM)
  */
   double _scale;
  /**
  * @brief [Conditional Variable Reference] Specifies the half-width at half-maximum (HWHM)
  */
