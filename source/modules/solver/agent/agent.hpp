...
class Agent : public Solver
{
  ...
  */
  ...
  /**
  * @brief Evaluate policy probabilities with fusion distribution.
  */
  ...
  * @brief TODO
  */
   float _rewardFunctionL2RegularizationEnabled;
  /**
  ...
  */
  ...
  std::vector<std::vector<std::vector<float>>> _backgroundTrajectoryLogProbabilities;
  std::vector<std::vector<std::vector<float>>> _demonstrationTrajectoryLogProbabilities;
  ...
  */
  ...
  {
    KORALI_LOG_ERROR("Reward rescaling not used in IRL");
  ...
  */
  ...
  virtual std::vector<float> evaluateTrajectoryLogProbability(const std::vector<std::vector<std::vector<float>>> &states, const std::vector<std::vector<std::vector<float>>> &actions, const std::vector<float> &policyHyperparameter) = 0;
  virtual std::vector<float> evaluateTrajectoryLogProbabilityWithObservedPolicy(const std::vector<std::vector<std::vector<float>>> &states, const std::vector<std::vector<std::vector<float>>> &actions) = 0;
  /****************************************************************************************************
