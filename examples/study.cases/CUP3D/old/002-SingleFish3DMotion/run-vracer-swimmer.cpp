...
int main(int argc, char *argv[])
{
   ...
   /* Setup state and actions based on the task that is simulated                          */
   /****************************************************************************************/
   /*
    * Task 0: Planar motion (2D or 3D). Swim from (x1,y1,0) to (x2,y2,0). 
              Cylinder pitching is provided as an action (but does nothing).
    * Task 1: Planar motion (2D or 3D). Swim from (x1,y1,0) to (x2,y2,0). 
              Torsion is provided as an action (but does nothing).
    * Task 2: 3D motion. Swim from (x1,y1,z1) to (x2,y2,z2). Use pitching motion (cylinder).
    * Task 3: 3D motion. Swim from (x1,y1,z1) to (x2,y2,z2). Use torsion for pitching.
    *
    */
   int nAgents = 0;
   ...
   {
      if (rank == 0)
         std::cout << "Provided wrong task." << std::endl;
