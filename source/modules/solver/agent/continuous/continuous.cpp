...
#ifdef NOISY
      printf("dp: %f %f %f %f\n", oldMu, oldSigma, curMu, curSigma);
      printf("f %f %f %f\n", normalLogCDF(_actionLowerBounds[i], oldMu, oldSigma), normalLogCDF(_actionLowerBounds[i], curMu, curSigma), normalLogDensity(_actionLowerBounds[i], curMu, curSigma));
      fflush(stdout);
#endif
