...
/** \file
* @brief Header file for module: Laplace.
*/

/** \dir distribution/univariate/laplace
...
*/
class Laplace : public Univariate
{
  private:
  public: 
  /**
  ...
  */
  ...
  /*
  * @brief Updates distribution with new parameter (here width).
  */
