...
# AMR
$mpiflags ./run-vracer-transport  -bpdx 32 -bpdy 32 -levelMax 3 -Rtol 0.1 -Ctol 0.01 -poissonType cosine -muteAll 1 -verbose 0 -tdump 0 -nu 0.000018 -tend 0 -poissonType cosine -shapes 'smartDisk_radius=.06_xpos=.2'
