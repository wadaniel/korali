...
class Bayesian : public Problem
{
  ...
  */
  ...
  /**
  * @brief Evaluates the log prior of the given sample, and stores it in sample["logPrior"]
  * @param sample A Korali Sample
  */
  void evaluateLogPrior(korali::Sample &sample);

  /**
 * @brief Evaluates the log likelihood of the given sample, and stores it in sample["logLikelihood"]
 * @param sample A Korali Sample
 */
  virtual void evaluateLoglikelihood(korali::Sample &sample) = 0;

  /**
 * @brief Evaluates the log posterior of the given sample, and stores it in sample["logPosterior"]
 * @param sample A Korali Sample
 */
