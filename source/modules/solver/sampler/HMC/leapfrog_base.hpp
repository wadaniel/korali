...
class Leapfrog
{
  ...
  */
  virtual void step(std::vector<double> &q, std::vector<double> &p, const double stepSize, Hamiltonian *hamiltonian, size_t &modelEvaluationCount, const size_t &numSamples, std::vector<double> &inverseMetric) = 0;
};
