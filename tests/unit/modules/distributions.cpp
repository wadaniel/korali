...
namespace
{
 ...
 TEST(Distrtibutions, UniformRatioDistribution)
 {
  ...
  EXPECT_NEAR(d->getDensity( 3. ), 0.063657, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getDensity( 4. ), 0.031250, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getDensity( 5. ), 0.016250, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getDensity( 6. ), 0.008102, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getDensity( 7. ), 0.003189, PDENSITY_ERROR_TOLERANCE);
  ...
  EXPECT_NEAR(d->getLogDensity( 3. ), -2.754240, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getLogDensity( 4. ), -3.465736, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getLogDensity( 5. ), -4.119662, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getLogDensity( 6. ), -4.815662, PDENSITY_ERROR_TOLERANCE);
  EXPECT_NEAR(d->getLogDensity( 7. ), -5.748118, PDENSITY_ERROR_TOLERANCE);
  ...
  EXPECT_NEAR(d->getLogDensityGradient( 8. ), -INFINITY, PDENSITY_ERROR_TOLERANCE);
