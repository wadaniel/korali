...
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Neural Network"].erase("Output Activation");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Neural Network"]["Output Activation"] = knlohmann::json();
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Neural Network"].erase("Output Layer");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Neural Network"]["Output Layer"] = knlohmann::json();
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
...
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Neural Network"]["Engine"] = "Engine";
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
...
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs.erase("Hyperparameters");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Hyperparameters"] = "Not a Number";
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Hyperparameters"] = std::vector<float>({0.0});
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs.erase("Loss Function");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Loss Function"] = 1.0;
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Loss Function"] = "Direct Gradient";
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs.erase("Steps Per Generation");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Steps Per Generation"] = "Not a Number";
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Steps Per Generation"] = 10;
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
...
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs.erase("Output Weights Scaling");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Output Weights Scaling"] = "Not a Number";
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Output Weights Scaling"] = 1.0;
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Termination Criteria"].erase("Target Loss");
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Termination Criteria"]["Target Loss"] = "Not a Number";
//   ASSERT_ANY_THROW(agent->setConfiguration(agentJs));
//
//   agentJs = baseOptJs;
//   experimentJs = baseExpJs;
//   agentJs["Termination Criteria"]["Target Loss"] = 1.0;
//   ASSERT_NO_THROW(agent->setConfiguration(agentJs));
  }
