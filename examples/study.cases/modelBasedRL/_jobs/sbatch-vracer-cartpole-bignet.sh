...
srun -n 6 python3 run-vracer-cartpole.py --epoch 100 --batch 64 --lr 1e-3 --ws 4.0 --hid 64 64 --iniRetrain $INI --retrain $RE --trRewTh 500 --tarAvRew 0 --launchNum 10 --maxGen 1000000 --dumpBestTrajectory --conf $CONF --m "${M}" --expBetPolUp 1.0 --testFreq 1 --maxPolUp 100000
