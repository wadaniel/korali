...
std::string OPTIONS = "-bpdx 4 -bpdy 2 -levelMax 7 -levelStart 4 -Rtol 2 -Ctol 1 -extent 2 -CFL 0.4 -poissonTol 1e-7 -poissonTolRel 1e-4 -maxPoissonRestarts 100 -bAdaptChiGradient 0 -tdump 0.1 -nu 0.00004 -tend 0 -muteAll 0 -verbose 1";
